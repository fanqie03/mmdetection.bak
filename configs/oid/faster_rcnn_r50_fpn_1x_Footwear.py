...
# dataset settings
dataset_type = 'OIDTDataset'
data_root = '/home/cmf/datasets/open-image/OID/'
class_description = data_root + 'csv_folder/class-descriptions-boxable.csv'
# classes = ['']
img_norm_cfg = dict(
...
data = dict(
    ...
    val=dict(
        ...
        img_prefix=data_root + 'Dataset/validation/',
        class_description=class_description,
        classes=('Footwear',),
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'annotations/test-annotations-bbox.csv',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_Footwear'
load_from = None
resume_from = None
workflow = [('train', 1)]
